/*
* 大阪工業大学情報メディア学科「情報メディア演習Ⅱ」の授業プログラム
* @authour: Sho Ooi
* @version: 1
* @date: 2020.01.01
* @contents
*	1st week: Image process.
*   2nd week: Face detection, expression recognition and human detection
*   3rd week: Video processing
*   4th week: Machine learning
*   5th week: Skeleton detection and action recognition
*   6th week: Reports
*/
